...
namespace CHBase.SDK.Mobile
{
    ...
    public class CHBaseRecord
    {
        ...
        internal CHBaseRecord(Guid personId, Guid recordId)
        {
            PersonId = personId;
            RecordId = recordId;
        }
        ...
        public static CHBaseRecord Create(Guid personId, string personName, string recordXml)
        {
            CHBaseRecord record = new CHBaseRecord();
