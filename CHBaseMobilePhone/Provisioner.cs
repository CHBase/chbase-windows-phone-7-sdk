...
namespace CHBase.SDK.Mobile
{
    ...
    internal static class Provisioner
    {
        ...
        internal class AuthenticationCheckState
        {
            ...
            /// </summary>
            public CHBaseService Service { get; set; }

            /// <summary>
            /// Gets or sets the authentication completed handler.
            /// </summary>
            public EventHandler<CHBaseResponseEventArgs> AuthenticationCompletedHandler { get; set; }

            /// <summary>
            /// Gets or sets the Shell Authorization required handler.
            /// </summary>
            public EventHandler<CHBaseResponseEventArgs> ShellAuthRequiredHandler { get; set; }
        }
    }
}
