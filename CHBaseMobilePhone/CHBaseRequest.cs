...
namespace CHBase.SDK.Mobile
{
    ...
    public class CHBaseRequest
    {
        ...
        /// </summary>
        public EventHandler<CHBaseResponseEventArgs> ResponseCallback { get; set; }
        ...
        /// </summary>
        public CHBaseResponse Response { get; set; }
