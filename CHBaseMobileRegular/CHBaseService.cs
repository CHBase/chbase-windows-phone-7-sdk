...
namespace CHBase.SDK.Mobile
{
    ...
    public class CHBaseService
    {
        ...
        /// </summary>
        public CHBaseRecord CurrentRecord { get; set; }

        /// <summary>
        /// Gets the list of records that this application is authorized to use.
        /// </summary>
        public List<CHBaseRecord> Records { get; internal set; }
        ...
        public void LoadSettings(string name)
        {
            ...
            if (settingsXml != null)
            {
                ...
                if (settings.Element("PersonId") != null)
                {
                    ...
                    CurrentRecord = new CHBaseRecord(personId, recordId);
                }
            }
        }
        ...
        internal XElement CreateCastCallInfoSection()
        {
            ...
            s = CHBaseService.GetOuterXml(content);
